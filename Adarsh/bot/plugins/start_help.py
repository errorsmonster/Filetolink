...
async def start(b, m):
    ...
    if usr_cmd == "/start":
        ...
        await m.reply_photo(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [InlineKeyboardButton("⚡ 𝚄𝙿𝙳𝙰𝚃𝙴𝚂 ⚡", url="https://t.me/The_Publishers"), InlineKeyboardButton("⚡ 𝚂𝚄𝙿𝙿𝙾𝚁𝚃 ⚡", https://t.me/+Z1yPQ4qCxoZjNGY1")],
                    [InlineKeyboardButton("📺 24/7 𝙼𝙾𝚅𝙸𝙴𝚂 📺", https://t.me/+Z1yPQ4qCxoZjNGY1"), InlineKeyboardButton("💎 𝙾𝚃𝚃 𝙼𝙾𝚅𝙸𝙴𝚂 💎", url="https://t.me/The_Publishers")],
                    [InlineKeyboardButton("💌 𝙼𝙾𝚅𝙸𝙴 𝙱𝙾𝚃 💌", url="https://t.me/The_Publishers1_bot")]
                ]
            ),
